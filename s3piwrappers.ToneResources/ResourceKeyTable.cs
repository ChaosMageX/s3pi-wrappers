...
namespace s3piwrappers
{
    ...
    public class ResourceKeyTable
    {
        ...
        private readonly CountSize mCountSize;
        private readonly string mFormat;
        private readonly List<IResourceKey> mKeys;
        ...
        private void WriteKey(BinaryWriter w, IResourceKey key)
        {
            foreach (char c in mFormat)
            {
                ...
                {
                case 'T':
                    w.Write(key.ResourceType);
                    break;
                case 'G':
                    w.Write(key.ResourceGroup);
                    break;
                case 'I':
        ...
        public ICollection<IResourceKey> Keys
        {
            get { return mKeys; }
        }
        ...
        {
            foreach (IResourceKey k in keys) Add(k);
        }
