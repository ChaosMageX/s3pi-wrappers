...
namespace s3piwrappers.SceneGraph
{
    ...
    public interface IResourceConnection
    {
        ...
        /// <summary>
        ///   <para> The actions to be taken by the containing <see cref="ResourceGraph" /> relating to the resource data of the child node. </para>
        ///   <para> The Find flag determines if the ResourceGraph searches the FileTable for the child's <see cref="IResource" /> data or just passes null to <see
        ///    cref="CreateChild" /> </para>
        ///   <para> The Write flag determines if the child node's <see cref="IResourceNode.Resource" /> data is written to the final package </para>
        /// </summary>
        ...
        /// </summary>
        /// <param name="resource"> The resource created by the <see cref="s3pi.WrapperDealer.WrapperDealer" /> from data located by the <see
        ///    cref="T:s3pi.Filetable.FileTable" /> via the <see cref="OriginalChildKey" /> property. </param>
        /// <param name="constraints"> Constraints to control how the new resource node is created from the original resource. </param>
        /// <returns> A new resource node instance containing resource data that will be will be changed by its child connections and written to a package. </returns>
