...
namespace s3piwrappers.FreeformJazz.Widgets
{
        ...
        : GraphElement, IGraphEdge<DGNode>, IUpdateable, IEquatable<DGEdge>
    {
        ...
        public DGEdge(DGNode srcNode, DGNode dstNode, bool autoGen)
        {
            if (srcNode == null)
            {
