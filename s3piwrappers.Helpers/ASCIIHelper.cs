...
namespace s3piwrappers.Helpers
{
    ...
    {
        private static readonly byte[] sAllVisual = new byte[]
        {
        ...
        private static readonly byte[] sNextVisual = new byte[]
        {
            ...
            0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0xa1, 0xa1,
        ...
        public static char GetNextVisualChar(char value)
        {
            if (value > 0xff)
            {
                return value;
            }
            return (char)sNextVisual[value];
        }

        private static readonly byte[] sPrevVisual = new byte[]
        {
            0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21,
            0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21, 0x21,
            0x21, 0x21, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e,
            ...
            0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e, 0x7e,
            0x7e, 0x7e, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae,
        ...
        public static char GetPrevVisualChar(char value)
        {
            if (value > 0xff)
            {
                return value;
            }
            return (char)sPrevVisual[value];
        }
    }
}
