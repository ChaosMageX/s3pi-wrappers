...
namespace s3piwrappers.Granny2
{
    public class GrannyFileInfo : GrannyElement
    {
        ...
        public GrannyFileInfo(int APIversion, EventHandler handler, GrannyFileInfo basis)
            : this(APIversion, handler, new ArtToolInfo(0,handler,basis.ArtToolInfo), new Skeleton(0,handler,basis.Skeleton), new Model(0,handler,basis.Model), basis.FromFileName) { }
        ...
        public ArtToolInfo ArtToolInfo
        {
            ...
            set { if(mArtToolInfo!=value){mArtToolInfo = value; OnElementChanged();} }
        }
        [ElementPriority(2)]
        public string FromFileName
        {
            get { return mFromFileName; }
            set { if(mFromFileName!=value){mFromFileName = value; OnElementChanged();} }
        }
        [ElementPriority(3)]
        public Model Model
        {
            get { return mModel; }
            set { if(mModel!=value){mModel = value; OnElementChanged();} }
        }
        [ElementPriority(4)]
        public Skeleton Skeleton
        {
            get { return mSkeleton; }
            set { if(mSkeleton!=value){mSkeleton = value; OnElementChanged();} }
        }
