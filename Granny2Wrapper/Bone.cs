...
namespace s3piwrappers.Granny2
{
    public class Bone : GrannyElement, IEquatable<Bone>
    {
        ...
        public Bone(int APIversion, EventHandler handler, Bone basis)
            : this(APIversion, handler, basis.mName, basis.mParentIndex, basis.mLocalTransform, basis.mInverseWorld4x4) { }
            ...
            : base(APIversion, handler)
        {
            ...
            mLocalTransform = new Transform(0, handler, localTransform);
            mInverseWorld4x4 = new Matrix4x4(0, handler, inverseWorld4X4);
        }
