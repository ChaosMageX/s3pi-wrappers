...
namespace s3piwrappers
{
    public class EffectResource : AResource
    {
        ...
        public abstract class AbstractEffectSection : AHandlerElement, IEquatable<AbstractEffectSection>
        {
            ...
            public static AbstractEffectSection CreateInstance(int apiVersion, EventHandler handler, ushort type, ushort version, Stream s)
            {
                switch (type)
                {
                    ...
                    case 0x000B:
                        return new UnknownType11EffectSection(apiVersion, handler, type, version, s);
                    case 0x000C:
                        return new UnknownType12EffectSection(apiVersion, handler, type, version, s);
                    case 0x000D:
                        return new DistributeEffectSection(apiVersion, handler, type, version, s);
                    case 0x000E:
                        return new UnknownType14EffectSection(apiVersion, handler, type, version, s);
                    default:
            ...
            where TEffect : AbstractEffect, IEquatable<TEffect>
        {
            ...
            {
                mList = new EffectList<TEffect>(handler,s);
            }
        ...
        public class UnknownType11EffectSection : AbstractEffectSection<DefaultEffect>
        {
            internal UnknownType11EffectSection(int apiVersion, EventHandler handler, UInt16 type, UInt16 version, Stream s)
                : base(apiVersion, handler, type, version, s) { }
        }
        [ConstructorParameters(new object[] { 0x000C, 0x0001 })]
        public class UnknownType12EffectSection : AbstractEffectSection<DefaultEffect>
        {
            internal UnknownType12EffectSection(int apiVersion, EventHandler handler, UInt16 type, UInt16 version, Stream s)
                : base(apiVersion, handler, type, version, s) { }
        }
        ...
        public class UnknownType14EffectSection : AbstractEffectSection<DefaultEffect>
        {
            internal UnknownType14EffectSection(int apiVersion, EventHandler handler, UInt16 type, UInt16 version, Stream s)
                : base(apiVersion, handler, type, version, s) { }
        }
            ...
            where TEffect : AbstractEffect, IEquatable<TEffect>
        {
            ...
            public EffectList(EventHandler handler)
                : this(handler,null) { }
            public EffectList(EventHandler handler, Stream s)
                : base(handler)
            {
                if (s != null) Parse(s);
            }
        ...
        public abstract class AbstractEffect : AHandlerElement, IEquatable<AbstractEffect>
        {
            ...
            protected AbstractEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler) { if (s != null)Parse(s); }
        ...
        {            
            ...
            public ParticleEffect(int apiVersion, EventHandler handler)
                : base(apiVersion, handler)
            {
                mParticleParams = new EffectResource.ParticleParams(RecommendedApiVersion, handler);
            ...
            public ParticleEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
            ...
            public class ItemB : AHandlerElement, IEquatable<ItemB>
            {
                ...
                public UInt64 Long01
                {
                    ...
                    set
                    {
                        mLong01 = value; OnElementChanged();
                    }
                }
                [ElementPriority(3)]
                public float Float01
                {
                    ...
                    set
                    {
                        mFloat01 = value; OnElementChanged();
                    }
                }
                [ElementPriority(4)]
                public float Float02
                ...
                public byte[] ByteArray01
                {
                    ...
                    set
                    {
                        mByteArray01 = value; OnElementChanged();
                    }
                }
                [ElementPriority(8)]
                public String String01
                {
                    ...
                    set
                    {
                        mString01 = value; OnElementChanged();
                    }
                }
                [ElementPriority(9)]
                public String String02
                {
                    ...
                    set
                    {
                        mString02 = value; OnElementChanged();
                    }
                }
                [ElementPriority(10)]
            ...
            #region Fields
            private UInt32 mInt01;
            private ParticleParams mParticleParams;
            ...
            private ulong mResourceInstance;
            private UInt16 mShort02 = 0x0080;
            private UInt32 mInt02;
            private UInt32 mInt03;
            private float mFloat10;
            private Byte[] mByteArray02 = new byte[8] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
            private Byte mByte01;
            private UInt16 mShort03;
            ...
            private Byte[] mByteArray03 = new byte[4] { 0x00, 0xFF, 0x00, 0xFF };
            private Byte[] mByteArray04 = new byte[4] { 0x00, 0x00, 0x00, 0x00 };
            ...
            private float mFloat25 = -1000000000.0f;
            private float mFloat26;
            private float mFloat27 = -10000.0f;
            private float mFloat28 = 10000.0f;
            ...
            {
                get { return mParticleParams; }
                set { mParticleParams = value; OnElementChanged(); }
            }
            [ElementPriority(3)]
            public FloatList Rotations
            {
            ...
            [ElementPriority(20)]
            public ulong ResourceInstance
            {
                get { return mResourceInstance; }
                set { mResourceInstance = value; OnElementChanged(); }
            }
            [ElementPriority(21)]
            public UInt16 Short02
            {
                get { return mShort02; }
            ...
            protected override void Parse(Stream stream)
            {
                ...
                mParticleParams = new ParticleParams(RecommendedApiVersion, handler, stream);
                ...
                s.Read(out mResourceInstance);
                s.Read(out mShort02);
                s.Read(out mInt02);
                s.Read(out mInt03);
                s.Read(out mFloat10);
                s.Read(out mByteArray02, 8);
                s.Read(out mByte01);
                s.Read(out mShort03);
                s.Read(out mByte02);
                s.Read(out mByte03);
                ...
                s.Read(out mByteArray03, 4);
                s.Read(out mByteArray04, 4);
                ...
                s.Read(out mFloat24);
                s.Read(out mByteArray05, 16);
                s.Read(out mFloat25);
                s.Read(out mFloat26);
                s.Read(out mFloat27, ByteOrder.LittleEndian);
                s.Read(out mFloat28, ByteOrder.LittleEndian);
                s.Read(out mByteArray06, 24);
                s.Read(out mFloat29, ByteOrder.LittleEndian);
                s.Read(out mFloat30, ByteOrder.LittleEndian);
                s.Read(out mFloat31, ByteOrder.LittleEndian);
                s.Read(out mFloat32, ByteOrder.LittleEndian);
                s.Read(out mFloat33);
                s.Read(out mFloat34);
                s.Read(out mFloat35);
                ...
                s.Read(out mByte07);
                s.Read(out mFloat36, ByteOrder.LittleEndian);
                s.Read(out mFloat37, ByteOrder.LittleEndian);
                s.Read(out mFloat38, ByteOrder.LittleEndian);

                mFloatList08 = new FloatList(handler, stream);

                s.Read(out mFloat39);
                s.Read(out mFloat40);
                s.Read(out mByteArray07, 16);
            ...
            public override void UnParse(Stream stream)
            {
                BinaryStreamWrapper s = new BinaryStreamWrapper(stream, ByteOrder.BigEndian);
                s.Write(mInt01);
                mParticleParams.UnParse(stream);
                ...
                s.Write(mFloat25);
                s.Write(mFloat26);
                s.Write(mFloat27, ByteOrder.LittleEndian);
                s.Write(mFloat28, ByteOrder.LittleEndian);
                s.Write(mByteArray06);
                s.Write(mFloat29, ByteOrder.LittleEndian);
                s.Write(mFloat30, ByteOrder.LittleEndian);
                s.Write(mFloat31, ByteOrder.LittleEndian);
                s.Write(mFloat32, ByteOrder.LittleEndian);
                s.Write(mFloat33);
                s.Write(mFloat34);
                s.Write(mFloat35);
                ...
                s.Write(mByte07);
                s.Write(mFloat36, ByteOrder.LittleEndian);
                s.Write(mFloat37, ByteOrder.LittleEndian);
                s.Write(mFloat38, ByteOrder.LittleEndian);
        ...
        public class MetaparticleEffect : AbstractEffect, IEquatable<MetaparticleEffect>
        {
                ...
                : base(apiVersion, handler)
            {
                ...
                mItemAList01 = new ItemAList(handler);
                mItemBList01 = new ItemBList(handler);
                mItemCList01 = new ItemCList(handler);
                ...
                mFloatList05 = new FloatList(handler);
                mColorList01 = new ColorList(handler);
                mByteArray01 = new byte[4];
                mByteArray02 = new byte[4];
                mByteArray03 = new byte[24];
                mByteArray04 = new byte[8];
                mByteArray05 = new byte[8];
                mByteArray07 = new byte[20];
                mByteArray08 = new byte[12];
                mByteArray09 = new byte[8];
                mByteArray10 = new byte[4];
                mByteArray11 = new byte[8];
                mByteArray12 = new byte[16]
                {
                    0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00,
            ...
            public MetaparticleEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
            ...
            public class ItemA : AHandlerElement, IEquatable<ItemA>
            {
                ...
                public ItemA(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler) { Parse(s); }
                public ItemA(int apiVersion, EventHandler handler)
                    : base(apiVersion, handler)
                {
                    mByteArray01 = new byte[3];
                    mByteArray02 = new byte[9];
                }
                ...
                {
                    BinaryStreamWrapper s = new BinaryStreamWrapper(stream, ByteOrder.BigEndian);
                    s.Read(out mByteArray01, 3);
                    s.Read(out mFloat01);
                    s.Read(out mFloat02);
                    s.Read(out mFloat03);
                    s.Read(out mByteArray02, 9);
                }
            ...
            private float mFloat06;
            private byte[] mByteArray09;
            private byte[] mByteArray10;
            private byte[] mByteArray11;
            private ItemBList mItemBList01;
            private float mFloat07;
            private byte[] mByteArray12;
            private float mFloat08;
            private float mFloat09;
            private float mFloat10;
            private float mFloat11;
            private byte[] mByteArray13;
            private float mFloat12;
            private float mFloat13;
            private float mFloat37;
            private float mFloat38;
            ...
            private float mFloat45;
            private float mFloat46;
            private float mFloat47;
            ...
            {
                get { return mByteArray09; }
                set { mByteArray09 = value; OnElementChanged(); }
            }
            [ElementPriority(29)]
            public byte[] ByteArray09
            {
                get { return mByteArray10; }
                set { mByteArray10 = value; OnElementChanged(); }
            }
            [ElementPriority(30)]
            public byte[] ByteArray10
            {
                get { return mByteArray11; }
                set { mByteArray11 = value; OnElementChanged(); }
            }
            [ElementPriority(31)]
            ...
            {
                get { return mByteArray12; }
                set { mByteArray12 = value; OnElementChanged(); }
            }
            [ElementPriority(34)]
            public float Float08
            {
            ...
            [ElementPriority(37)]
            public byte[] ByteArray12
            {
                get { return mByteArray13; }
                set { mByteArray13 = value; OnElementChanged(); }
            }
            [ElementPriority(38)]
            public float Float12
            {
            ...
            [ElementPriority(58)]
            public byte[] ByteArray13
            {
                get { return mByteArray14; }
                set { mByteArray14 = value; OnElementChanged(); }
            }
            ...
            protected override void Parse(Stream stream)
            {
                ...
                s.Read(out mFloat04, ByteOrder.LittleEndian);
                s.Read(out mByteArray07, 20);
                s.Read(out mFloat05);
                s.Read(out mByteArray08, 12);
                s.Read(out mFloat06);
                s.Read(out mByteArray09, 8);
                s.Read(out mByteArray10, 4);
                s.Read(out mByteArray11, 8);

                mItemBList01 = new ItemBList(handler, stream);

                s.Read(out mFloat07);
                s.Read(out mByteArray12, 16);
                s.Read(out mFloat08);
                s.Read(out mFloat09);
                s.Read(out mFloat10, ByteOrder.LittleEndian);
                s.Read(out mFloat11, ByteOrder.LittleEndian);
                s.Read(out mByteArray13, 24);
                s.Read(out mFloat12, ByteOrder.LittleEndian);
                s.Read(out mFloat13, ByteOrder.LittleEndian);
                s.Read(out mFloat37, ByteOrder.LittleEndian);
                s.Read(out mFloat38, ByteOrder.LittleEndian);
                ...
                s.Read(out mByte02);
                s.Read(out mFloat42, ByteOrder.LittleEndian);
                s.Read(out mFloat43, ByteOrder.LittleEndian);
                s.Read(out mFloat44, ByteOrder.LittleEndian);
                s.Read(out mFloat45, ByteOrder.LittleEndian);
                s.Read(out mFloat46);
                s.Read(out mFloat47);
                s.Read(out mFloat48);
                s.Read(out mByte03);
            ...
            public override void UnParse(Stream stream)
            {
                ...
                s.Write(mFloat06);
                s.Write(mByteArray09);
                s.Write(mByteArray10);
                s.Write(mByteArray11);

                mItemBList01.UnParse(stream);

                s.Write(mFloat07);
                s.Write(mByteArray12);
                s.Write(mFloat08);
                s.Write(mFloat09);
                s.Write(mFloat10, ByteOrder.LittleEndian);
                s.Write(mFloat11, ByteOrder.LittleEndian);
                s.Write(mByteArray13);
                s.Write(mFloat12, ByteOrder.LittleEndian);
                s.Write(mFloat13, ByteOrder.LittleEndian);
                s.Write(mFloat37, ByteOrder.LittleEndian);
                s.Write(mFloat38, ByteOrder.LittleEndian);
                ...
                s.Write(mByte02);
                s.Write(mFloat42, ByteOrder.LittleEndian);
                s.Write(mFloat43, ByteOrder.LittleEndian);
                s.Write(mFloat44, ByteOrder.LittleEndian);
                s.Write(mFloat45, ByteOrder.LittleEndian);
                s.Write(mFloat46);
                s.Write(mFloat47);
                s.Write(mFloat48);
                s.Write(mByte03);
        ...
        public class DecalEffect : AbstractEffect, IEquatable<DecalEffect>
        {
            ...
            public DecalEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class SequenceEffect : AbstractEffect, IEquatable<SequenceEffect>
        {
            ...
            public SequenceEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class SoundEffect : AbstractEffect, IEquatable<SoundEffect>
        {
            ...
            public SoundEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class ShakeEffect : AbstractEffect, IEquatable<ShakeEffect>
        {
            ...
            public ShakeEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class CameraEffect : AbstractEffect, IEquatable<CameraEffect>
        {
            ...
            public CameraEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class ModelEffect : AbstractEffect, IEquatable<ModelEffect>
        {
            ...
            public ModelEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class ScreenEffect : AbstractEffect, IEquatable<ScreenEffect>
        {
            ...
            public ScreenEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class DistributeEffect : AbstractEffect, IEquatable<DistributeEffect>
        {
            ...
            public DistributeEffect(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler, s) { }
        ...
        public class Shader : AHandlerElement, IEquatable<Shader>
        {
            ...
            public class PropertyList : AResource.DependentList<Shader.Property>
            {
                ...
                protected override Shader.Property CreateElement(System.IO.Stream stream)
                {
                    BinaryStreamWrapper s = new BinaryStreamWrapper(stream, ByteOrder.BigEndian);
                ...
                protected override void WriteElement(System.IO.Stream stream, Shader.Property element)
                {
                    BinaryStreamWrapper s = new BinaryStreamWrapper(stream, ByteOrder.BigEndian);
            ...
            public Shader(int apiVersion, EventHandler handler, Shader basis) 
                : base(apiVersion,handler)
            {
                MemoryStream ms = new MemoryStream();
                basis.UnParse(ms);
            ...
            public Shader(int apiVersion, EventHandler handler)
                : base(apiVersion, handler)
            {
                mProperties = new PropertyList(handler);
            }
            public Shader(int apiVersion, EventHandler handler, Stream s) : base(apiVersion, handler) { Parse(s); }
        ...
        #region Nested Type: ShaderList
        public class ShaderList : AResource.DependentList<Shader>
        {
            public ShaderList(EventHandler handler) : base(handler) { }
            public ShaderList(EventHandler handler, Stream s) : base(handler, s) { }
            protected override uint ReadCount(Stream s)
            {
                uint count = new BinaryStreamWrapper(s, ByteOrder.BigEndian).ReadUInt32();
                return count;
            ...
            protected override Shader CreateElement(Stream s)
            {
                return new Shader(0, elementHandler, s);
            }

            protected override void WriteElement(Stream s, Shader element)
            {
                element.UnParse(s);
            }
        }
        ...
        {
            public Compilation(int apiVersion, EventHandler handler, Compilation basis) : base(apiVersion,handler)
            {
                MemoryStream ms = new MemoryStream();
                basis.UnParse(ms);
                ms.Position = 0L;
        ...
        [ElementPriority(3)]
        public ShaderList EffectShaders
        {
        ...
        public void Parse(Stream stream)
        {
            ...
            s.Read(out mUint01);
            s.Read(out mShort01);
            mEffectShaders = new ShaderList(this.OnResourceChanged, stream);
        ...
        protected override Stream UnParse()
        {
            ...
            s.Write(mUint01);
            s.Write(mShort01);
            if (this.mEffectShaders == null) this.mEffectShaders = new ShaderList(this.OnResourceChanged);
