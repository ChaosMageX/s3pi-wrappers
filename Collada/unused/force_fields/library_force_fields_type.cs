...
namespace DAESim.DAE
{
    ...
    public class library_force_fields_type : object, INotifyPropertyChanged
    {
        private asset_type assetField;

        private force_field_type[] force_fieldField;
        ...
        public force_field_type[] force_field
        {
            get { return this.force_fieldField; }
            set
            {
                this.force_fieldField = value;
                this.RaisePropertyChanged("force_field");
            }
        }
