...
namespace DAESim.DAE
{
    ...
    public class light_type : object, INotifyPropertyChanged
    {
        private asset_type assetField;

        private light_typeTechnique_common technique_commonField;
        ...
        /// <remarks />
        public light_typeTechnique_common technique_common
        {
