...
namespace DAESim.DAE
{
    ...
    public class library_physics_scenes_type : object, INotifyPropertyChanged
    {
        private asset_type assetField;

        private physics_scene_type[] physics_sceneField;
        ...
        public physics_scene_type[] physics_scene
        {
            get { return this.physics_sceneField; }
            set
            {
