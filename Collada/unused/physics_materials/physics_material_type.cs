...
namespace DAESim.DAE
{
    ...
    public class physics_material_type : object, INotifyPropertyChanged
    {
        private asset_type assetField;

        private physics_material_typeTechnique_common technique_commonField;
        ...
        /// <remarks />
        public physics_material_typeTechnique_common technique_common
        {
