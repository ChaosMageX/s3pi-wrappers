...
namespace DAESim.DAE
{
    ...
    public class camera_typeOpticsTechnique_commonPerspective : object, INotifyPropertyChanged
    {
        ...
        [XmlElement("xfov", typeof (targetable_float_type))]
        [XmlElement("yfov", typeof (targetable_float_type))]
