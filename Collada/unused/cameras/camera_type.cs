...
namespace DAESim.DAE
{
    ...
    public class camera_type : object, INotifyPropertyChanged
    {
        private asset_type assetField;

        private camera_typeOptics opticsField;

        private camera_typeImager imagerField;
        ...
        /// <remarks />
        public camera_typeOptics optics
        {
            get { return this.opticsField; }
            set
            {
        ...
        /// <remarks />
        public camera_typeImager imager
        {
            get { return this.imagerField; }
            set
            {
