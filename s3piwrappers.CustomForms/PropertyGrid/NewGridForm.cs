...
namespace s3piwrappers.CustomForms.PropertyGrid
{
    public partial class NewGridForm : Form
    {
        ...
        public NewGridForm()
        {
            ...
            this.Icon = Settings.Default.FormIcon;
            ...
            : this()
        {
            ...
            if (main)
            {
                ...
                size = Settings.Default.GridSize;
        ...
        {
            base.OnClosing(e);
            if (main) Settings.Default.GridSize = size;
        }
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            if (selectedElement != null)
                ...
                {
                    Settings.Default.IssueException(ex, "Copy failed");
                }
        ...
        void contextMenuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            {
                Settings.Default.IssueException(ex, "");
            }
            fillListBox(selectedIndex);
        }
