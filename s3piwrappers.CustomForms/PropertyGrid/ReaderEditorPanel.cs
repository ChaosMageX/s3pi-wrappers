...
using s3piwrappers.CustomForms.Controls;
...
namespace s3piwrappers.CustomForms.PropertyGrid
{
    public partial class ReaderEditorPanel : UserControl
    {
        ...
        public void SetField(AApiVersionedFields owner, string field)
        {
            ...
            {
                bool hasText = Settings.Default.TextEditorCmd != null && Settings.Default.TextEditorCmd.Length > 0;
                bool hasHex = Settings.Default.HexEditorCmd != null && Settings.Default.HexEditorCmd.Length > 0;
        ...
        private void Import_TextReader()
        {
            ...
            catch (Exception ex)
            {
                ...
                Settings.Default.IssueException(ex, "Text import failed.  Recovery attempted but resource may be corrupt.");
            }
            fs.Close();
        }
        private void Import_BinaryReader()
        {
            ...
            catch (Exception ex)
            {
                ...
                Settings.Default.IssueException(ex, "Binary import failed.  Recovery attempted but resource may be corrupt.");
            }
            fs.Close();
        }
        ...
        private void btnViewHex_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                f.Icon = Settings.Default.FormIcon;
                f.Text = "Hex view";
        ...
        {
            return s3pi.Helpers.HelperManager.Edit(key, res,
                Settings.Default.HexEditorCmd,
                Settings.Default.HexEditorWantsQuotes,
                Settings.Default.HexEditorIgnoreTS);
        }
    }
}
